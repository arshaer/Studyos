...
create table if not exists public.ai_requests (
  ...
  input_tokens int not null default 0, output_tokens int not null default 0,
  estimated_cost numeric(14,8), cost_status text not null default 'unknown',
  latency_ms int not null default 0, fallback_count int not null default 0,
  compression_enabled boolean not null default false, compression_policy text not null default 'off',
  compression_ratio numeric(6,5), success boolean not null, error_type text,
  created_at timestamptz not null default now()
);
